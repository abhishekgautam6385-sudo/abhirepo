  ...
  return (
    <section className="h-wrapper" style={{ background: headerColor }}>
      <div className="flexCenter innerWidth paddings h-container">
        {/* logo */}
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqBTgf2zKvk6POGZEm0ptfWxUois29qSD8LQ&s" alt="logo" width={100} />
        ...
        >
          ...
          >
            ...
            <button className="button">
              <a href="abhishek@gmail.com">Contact</a>
            </button>
          </div>
        </OutsideClickHandler>
